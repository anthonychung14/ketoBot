...
from .testDataMed import testTarget, macroDict, macroDict2, macroDict3
...
class SolutionTest_ComboAdjDown(unittest.TestCase):
    ...
    def test_iteratesThroughStaples(self):
        ...
        Result = IterateStaples(Estimate, Estimate.diff)        
        assert_equal(Result.staples[0].servings, 1)
        assert_equal(Result.staples[1].servings, 3)
        assert_equal(Result.staples[2].servings, 4)
